 ...
 */
class MultipartStream implements \_PhpScoper5f3e4b2e25c2b\Psr\Http\Message\StreamInterface
{
    ...
    {
        $stream = new \_PhpScoper5f3e4b2e25c2b\GuzzleHttp\Psr7\AppendStream();
    ...
    private function addElement(\_PhpScoper5f3e4b2e25c2b\GuzzleHttp\Psr7\AppendStream $stream, array $element)
    {
     ...
     * @return array
     */
    private function createElement($name, \_PhpScoper5f3e4b2e25c2b\Psr\Http\Message\StreamInterface $stream, $filename, array $headers)
    {
