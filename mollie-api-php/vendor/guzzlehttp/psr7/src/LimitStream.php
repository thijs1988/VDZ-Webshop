 ...
 */
class LimitStream implements \_PhpScoper5f3e4b2e25c2b\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function __construct(\_PhpScoper5f3e4b2e25c2b\Psr\Http\Message\StreamInterface $stream, $limit = -1, $offset = 0)
    {
        $this->stream = $stream;
        $this->setLimit($limit);
