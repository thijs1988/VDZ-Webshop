...
class StreamWrapper
{
     ...
     */
    public static function getResource(\_PhpScoper5f3e4b2e25c2b\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\_PhpScoper5f3e4b2e25c2b\Psr\Http\Message\StreamInterface $stream)
    {
