 ...
 */
class FulfilledPromise implements \_PhpScoper5f3e4b2e25c2b\GuzzleHttp\Promise\PromiseInterface
{
    private $value;
    ...
    public function then(callable $onFulfilled = null, callable $onRejected = null)
    {
        ...
        $queue = queue();
        $p = new \_PhpScoper5f3e4b2e25c2b\GuzzleHttp\Promise\Promise([$queue, 'run']);
        $value = $this->value;
