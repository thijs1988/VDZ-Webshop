...
class HandlerStack
{
    ...
    {
        $stack = new self($handler ?: \_PhpScoper5f3e4b2e25c2b\GuzzleHttp\Utils::chooseHandler());
        $stack->push(\_PhpScoper5f3e4b2e25c2b\GuzzleHttp\Middleware::httpErrors(), 'http_errors');
        $stack->push(\_PhpScoper5f3e4b2e25c2b\GuzzleHttp\Middleware::redirect(), 'allow_redirects');
        $stack->push(\_PhpScoper5f3e4b2e25c2b\GuzzleHttp\Middleware::cookies(), 'cookies');
        $stack->push(\_PhpScoper5f3e4b2e25c2b\GuzzleHttp\Middleware::prepareBody(), 'prepare_body');
        return $stack;
    }
    /**
     ...
     */
    public function __invoke(\_PhpScoper5f3e4b2e25c2b\Psr\Http\Message\RequestInterface $request, array $options)
    {
