    ...
    public function __invoke(\_PhpScoper5f3e4b2e25c2b\Psr\Http\Message\RequestInterface $request, array $options) : \_PhpScoper5f3e4b2e25c2b\GuzzleHttp\Promise\PromiseInterface
    {
        ...
        if (!$request->hasHeader('Content-Type')) {
            if ($uri = $request->getBody()->getMetadata('uri')) {
                if ($type = \_PhpScoper5f3e4b2e25c2b\GuzzleHttp\Psr7\mimetype_from_filename($uri)) {
        ...
        return $fn(\_PhpScoper5f3e4b2e25c2b\GuzzleHttp\Psr7\modify_request($request, $modify), $options);
    }
    /**
     * Add expect header
     */
    private function addExpectHeader(\_PhpScoper5f3e4b2e25c2b\Psr\Http\Message\RequestInterface $request, array $options, array &$modify) : void
    {
