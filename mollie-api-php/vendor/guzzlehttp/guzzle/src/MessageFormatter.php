...
class MessageFormatter
{
     ...
     */
    public function format(\_PhpScoper5f3e4b2e25c2b\Psr\Http\Message\RequestInterface $request, ?\_PhpScoper5f3e4b2e25c2b\Psr\Http\Message\ResponseInterface $response = null, ?\Throwable $error = null) : string
    {
        $cache = [];
        /** @var string */
        return \preg_replace_callback('/{\\s*([A-Za-z_\\-\\.0-9]+)\\s*}/', function (array $matches) use($request, $response, $error, &$cache) {
            ...
            switch ($matches[1]) {
                case 'request':
                    $result = \_PhpScoper5f3e4b2e25c2b\GuzzleHttp\Psr7\str($request);
                    break;
                case 'response':
                    $result = $response ? \_PhpScoper5f3e4b2e25c2b\GuzzleHttp\Psr7\str($response) : '';
                    break;
                case 'req_headers':
     ...
     */
    private function headers(\_PhpScoper5f3e4b2e25c2b\Psr\Http\Message\MessageInterface $message) : string
    {
        $result = '';
