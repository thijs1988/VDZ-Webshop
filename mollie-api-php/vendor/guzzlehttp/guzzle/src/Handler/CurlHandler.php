...
class CurlHandler
{
    ...
    {
        $this->factory = $options['handle_factory'] ?? new \_PhpScoper5f3e4b2e25c2b\GuzzleHttp\Handler\CurlFactory(3);
    }
    public function __invoke(\_PhpScoper5f3e4b2e25c2b\Psr\Http\Message\RequestInterface $request, array $options) : \_PhpScoper5f3e4b2e25c2b\GuzzleHttp\Promise\PromiseInterface
    {
        ...
        return \_PhpScoper5f3e4b2e25c2b\GuzzleHttp\Handler\CurlFactory::finish($this, $easy, $this->factory);
    }
}
